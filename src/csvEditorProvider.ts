    ...
    async resolveCustomEditor(
        ...
        try {
            ...
            const applyVersionToEditor = async (entry: VersionHistoryEntry) => {
                ...
                fs.writeFileSync(document.uri.fsPath, serializeCsv(), 'utf8');
